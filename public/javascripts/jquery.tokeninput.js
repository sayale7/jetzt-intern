...
(function($){
    ...
    $.TokenList = function(input, settings){
        ...
        var input_box = $("<input type=\"text\">").css({
            outline: "none"
        }).focus(function(){
        ...
        var hidden_input = $(input).hide().focus(function(){
            input_box.focus();
        }).blur(function(){
            input_box.blur();
        });
        ...
        var token_list = $("<ul />").addClass(settings.classes.tokenList).insertAfter(hidden_input).click(function(event){
        ...
        var dropdown = $("<div>").addClass(settings.classes.dropdown).insertAfter(token_list).hide();
        ...
        function get_element_from_event(event, element_type){
            ...
            if (target.is(element_type)) {
                ...
                if (target.parent(element_type).length) {
        ...
        function insert_token(id, value){
            var this_token = $("<li><p>" + value + "</p> <input type=\"hidden\" value=" + id + " name=\"message[to][]\"/>  </li>").addClass(settings.classes.token).insertBefore(input_token);
